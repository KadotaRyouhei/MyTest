...
public class NormalViewPagerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.normal_view_pager_activity);
        init();
        initData();
    }

    private void init() {
        mViewPager = (ViewPager) findViewById(R.id.vp_normal);
    ...
    private void initData() {
        ...
        for(int i =0; i < dataSize; i ++) {
            View view = LayoutInflater.from(NormalViewPagerActivity.this).inflate(R.layout.fold_view_pager_item,null);
        ...
        foldViewPagerAdapter = new FoldViewPagerAdapter(NormalViewPagerActivity.this, viewList);
